...
print("With the following weather conditions: temperature [%f] in Celcius, relative humidity [%f] of percent, \n wind speed [%f] in km/h, and  precipitation [%f] in mm/m2" % (temp, relative_humidity, wind,  precipitation))
...
print("With the following weather conditions: temperature [%f] in Celcius, relative humidity [%f] of percent, wind speed [%f] in km/h,\n and  precipitation [%f] in mm/m2" % (temp, relative_humidity, wind,  precipitation))
if model.predict([[temp, relative_humidity, wind,  precipitation]])[0]:
    print("Rain fall may occur.")
else:
    print("Rain fall may not occur.")